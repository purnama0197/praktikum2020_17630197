...
//apakah tombol name="simpan" di klik (ada)
if (isset($_POST['Submit'])) {
  // ambil nilai komponen name="nim" tampung ke variabel $nim
  $nim      = $_POST['nim'];
  $nama     = $_POST['nama'];
  $alamat   = $_POST['alamat'];
  ...
  $result = mysqli_query($con, "INSERT INTO mahasiswa(nim,nama,alamat,jenis_kelamin,email,telepon) VALUES('$nim','$nama','$alamat','$jk','$email','$telepon')") or  die(mysql_error($con));
  {
    $this->foo = $foo;
  }));
